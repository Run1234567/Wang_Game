...
**Wang\_Game** 是一个专为**华清远见 STM32U575 开发板**量身打造的嵌入式 GUI 游戏合集。本项目基于 TouchGFX 框架开发，内置了四款经典的触摸屏小游戏，并且深度融入了专属的“旺”主题元素。不管是用来验证开发板屏幕性能，还是单纯想看看“旺”的各种搞怪形态，这个项目都能完美胜任！
